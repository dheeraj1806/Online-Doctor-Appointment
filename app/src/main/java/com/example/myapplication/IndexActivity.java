...
public class IndexActivity extends AppCompatActivity {
    ...
    private AppBarConfiguration app;
        ...
        generate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (text.getText().toString().trim().length() == 0){
                    Toast.makeText(IndexActivity.this, "Enter Text", Toast.LENGTH_SHORT).show();
                }
                else{
                    try{
                        ...
                        download.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                MediaStore.Images.Media.insertImage(getContentResolver(), bitmap, "code_scanner"
                                        , null);
                                Toast.makeText(IndexActivity.this, "Saved to Gallery", Toast.LENGTH_SHORT)
                                        .show();
                            }
                        });
